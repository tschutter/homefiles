...
Tom Schutter cleaned the Python.
"""
...
class Uboat():
    ...
    def _parse_template(self, template):
        ...
        for element in template:
            if element[0] == '*':  # Needs to be replaced
                if element[-1] == '.':  # maintain punctuation
                ...
                if isinstance(chosen, list):
                    chosen = ' '.join(self._parse_template(chosen))
